package com.appestudos.gateway.web.rest;

import com.appestudos.gateway.GatewayappestudosApp;
import com.appestudos.gateway.config.TestSecurityConfiguration;
import com.appestudos.gateway.security.AuthoritiesConstants;
import com.appestudos.gateway.service.UserService;
...
import static com.appestudos.gateway.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import org.springframework.security.test.context.support.WithMockUser;
...
@SpringBootTest(classes = {GatewayappestudosApp.class, TestSecurityConfiguration.class})
