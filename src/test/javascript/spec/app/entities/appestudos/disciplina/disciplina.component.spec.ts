...
import { DisciplinaComponent } from 'app/entities/appestudos/disciplina/disciplina.component';
import { DisciplinaService } from 'app/entities/appestudos/disciplina/disciplina.service';
import { Disciplina } from 'app/shared/model/appestudos/disciplina.model';
...
describe('Component Tests', () => {
  describe('Disciplina Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.disciplinas && comp.disciplinas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
