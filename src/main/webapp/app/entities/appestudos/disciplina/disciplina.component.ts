...
export class DisciplinaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.disciplinaService
      ...
      .subscribe(
        (res: HttpResponse<IDisciplina[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IDisciplina[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
